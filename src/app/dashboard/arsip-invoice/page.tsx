...
export default function ArsipInvoicePage() {
  ...
  const fetchData = async () => {
    try {
      const q = query(collection(db, "arsipInvoice"));
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        ...
        <Table columns={columns} data={paginatedData} isLoading={isLoading} emptyMessage="Belum ada arsip invoice" keyExtractor={(row) => row.id} onRowClick={handleDetail} />
        <PaginationControls />
      </Card>
