...
const allMenuItems = [
  ...
  {
    href: "/dashboard/pengganti-barang-rusak",
    label: "Pengganti Barang Rusak",
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    href: "/dashboard/barang-keluar-backup",
    label: "Barang Keluar Backup",
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    href: "/dashboard/aset-perusahaan",
